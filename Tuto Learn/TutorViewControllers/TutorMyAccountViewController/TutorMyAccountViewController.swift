    ...
    func setStudentData(studentArray:Array<Any>)  {
        ...
        for studentData in studentArray {
            ...
            if let studentDataTemp = studentData as? NSDictionary
            {
                ...
                let studentBoard = NSMutableDictionary.init(objects: [studentDataTemp["sm_board"] ?? "","Board"], forKeys: ["value" as NSCopying,"title" as NSCopying])
                let studentlevel = NSMutableDictionary.init(objects: [studentDataTemp["sm_level"] ?? "","Grade"], forKeys: ["value" as NSCopying,"title" as NSCopying])
